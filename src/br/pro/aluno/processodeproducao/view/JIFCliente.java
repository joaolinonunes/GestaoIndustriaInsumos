...
public class JIFCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jtbDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CPF", "Nome", "Senha", "CEP", "Cidade", "Rua", "N°"
            }
        ) {
    ...
    private void jtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtPesquisaKeyReleased
        try {
            if(jtPesquisa.getText().trim().length()>=1){
                listaUsuario = DAO1.pesquisar(jtPesquisa.getText());
                lista = DAO.pesquisar(jtPesquisa.getText());
                DefaultTableModel mp = (DefaultTableModel) jtbDados.getModel();
                mp.setNumRows(0);//limpar a tabela
                 //for(UsuarioModel bo : listaUsuario){
                   //   mp.addRow(new String[]{bo.getCpf(),bo.getNome(),bo.getSenha(),""+bo.getCep(), bo.getCidade(), bo.getRua(),""+bo.getNro(),  bo.getEmail()});
                //}
                for(ClienteModel ob : lista){
                    mp.addRow(new String[]{
                    ob.getCpf(),ob.getNome(),ob.getSenha(),""+ob.getCep(), ob.getCidade(), ob.getRua(),""+ob.getNro(),  ob.getEmail(),
                ob.getDataCadastro(),ob.getRepresenta()});// ob.getSenha(), ""+ob.getCep(), ob.getCidade(), ob.getRua(), ""+ob.getNro(),
                }
    ...
    private void jtbDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbDadosMouseClicked
        try {
            ...
            if(linha > -1){
                jtCpf.setText(lista.get(linha).getCpf());
                jtNome.setText(lista.get(linha).getNome());
                jtSenha.setText(lista.get(linha).getSenha());
                jtCep.setText(""+lista.get(linha).getCep());
                jtCidade.setText(lista.get(linha).getCidade());
                jtRua.setText(lista.get(linha).getRua());
                jtNro.setText(""+lista.get(linha).getNro());
                jtEmail.setText(lista.get(linha).getEmail());
                jtDataCadastro.setText(lista.get(linha).getDataCadastro());
                jtRepresenta.setText(lista.get(linha).getRepresenta());
                jtCpf.setEnabled(false);
                jtNome.setEnabled(false);
                jtSenha.setEnabled(false);
                jtCidade.setEnabled(false);
