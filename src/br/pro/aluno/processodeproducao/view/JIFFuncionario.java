    ...
    private void jtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtPesquisaKeyReleased
        try {
            if(jtPesquisa.getText().trim().length()>=1){
                ...
                for(FuncionarioModel ob : lista){
                    mp.addRow(new String[]
                    {ob.getCpf(), ob.getNome(),ob.getSenha(), ""+ob.getCep(), ob.getCidade(), ob.getRua(), ""+ob.getNro(),ob.getEmail(),ob.getCargo(),ob.getDataContratacao()});
    ...
    private void jtbDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbDadosMouseClicked
        try {
            ...
            if(linha > -1){
                ...
                jtDataContratacao.setText(lista.get(linha).getDataContratacao());
                jtCargo.setText(lista.get(linha).getCargo());
                jtCpf.setEnabled(false);
                jtNome.setEnabled(false);
                jtSenha.setEnabled(false);
                jtCidade.setEnabled(false);
 ...
 private boolean validarCampos() {
    ...
    //SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
     private boolean preencherObjeto() throws ParseException {
        ...
        obj.setDataContratacao(jtDataContratacao.getText());
        return true;
    }
